...
In order to make sure that lease make sure reconstruction is fast enough - please select a sufficient number of CPU cores (e.g., > 8) and amount of RAM (e.g., > 15 GB) in the docker settings. 
