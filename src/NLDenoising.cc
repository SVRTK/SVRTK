...
RealImage NLDenoising::Run(RealImage input_image, int input_param_w, int input_param_f)
{
    ...
    RealImage image = input_image;
    RealImage output_image = input_image;
...
RealImage NLDenoising::Run(RealImage input_image)
{
    
    RealImage output_image = input_image;
    
    output_image = Run(input_image, 3, 1);
