...
//    {
//        rec_argument arg;
//        arg = *(rec_argument*)pArguments;
//
//        arg->recon_p->SVRStep(arg->inputIndex);
//
//        pthread_exit(0);
//
//        return 0;
...
//    void ReconstructionFFD::GetSVRInput( RealImage& grey_reconstructed, Array<RealImage>& grey_slices, Array<MultiLevelFreeFormTransformation*>& global_mffd_transformations, Array<MultiLevelFreeFormTransformation*>& slice_mffd_transformations, Array<RigidTransformation>& package_transformations )
//    {
//
//        grey_reconstructed = _grey_reconstructed;
//
//        grey_slices.clear();
//        global_mffd_transformations.clear();
//        slice_mffd_transformations.clear();
//        package_transformations.clear();
//
//
//        for ( int inputIndex = 0; inputIndex < _grey_slices.size(); inputIndex++ ) {
//
//            grey_slices.push_back(_grey_slices[inputIndex]);
//            global_mffd_transformations.push_back(_global_mffd_transformations[inputIndex]);
//            slice_mffd_transformations.push_back(_mffd_transformations[inputIndex]);
//            package_transformations.push_back(_package_transformations[inputIndex]);
//        }
//
//
//     }
//
//     void ReconstructionFFD::SetSVROutput( Array<MultiLevelFreeFormTransformation*>& slice_mffd_transformations )
//    {
//
//        for ( int inputIndex = 0; inputIndex < _grey_slices.size(); inputIndex++ ) {
//    //        _mffd_transformations[inputIndex] = slice_mffd_transformations[inputIndex];
//            _mffd_transformations.push_back(slice_mffd_transformations[inputIndex]);
//
//        }
//    }
//
...
//         if (_reconstructed.GetXSize() < 1.1) {
//         GenericLinearInterpolateImageFunction<RealImage> interpolator_res;
//         Resampling<RealPixel> resampling(0.95, 0.95, 0.95);
//         resampling.Interpolator(&interpolator_res);
//
