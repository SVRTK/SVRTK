...
void usage()
{
    cout << "Usage: mirtk reconstruct_ffd [reconstructed] [N] [stack_1] .. [stack_N] <options>\n" << endl;
    cout << endl;
...
//        template_stack = stacks[templateNumber]->GetRegion(0,0,0,0,stacks[0]->GetX(),stacks[0]->GetY(),stacks[0]->GetZ(),(1));
//
//    } else {
...
//        nPackages = 4;
    ...
    if (structural_exclusion) {
        ...
        // reconstruction->FastCreateSliceMasks(grey_mask, -1);
    }
